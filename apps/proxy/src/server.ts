...
function recordProxyOutcome(
  ...
  //   Exception: BLOCKED_THREAT after an approval overrides 'approved' with 'blocked'.
  // - Otherwise, derive from the interceptor action.
  let outcome: import('./types.js').ToolCallEvent['outcome'];
